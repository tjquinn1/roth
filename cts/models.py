...
class Abusebehav(models.Model):
    abuseid = models.AutoField(primary_key=True, db_column='ABUSEID', unique=True)  # Field name made lowercase.
...
class Adhsscreen(models.Model):
    adhsid = models.AutoField(primary_key=True, db_column='ADHSID', unique=True)  # Field name made lowercase.
    clientid = models.IntegerField(db_column='CLIENTID', blank=True, null=True)  # Field name made lowercase.
    programid = models.IntegerField(db_column='PROGRAMID', blank=True, null=True)  # Field name made lowercase.
...
class Asusscore(models.Model):
    asid = models.AutoField(primary_key=True, unique=True)
...
class Cage(models.Model):
    cageid = models.AutoField(primary_key=True, db_column='CAGEID', unique=True)  # Field name made lowercase.
    clientid = models.IntegerField(db_column='CLIENTID', blank=True, null=True)  # Field name made lowercase.
    programid = models.IntegerField(db_column='PROGRAMID', blank=True, null=True)  # Field name made lowercase.
...
class Devnames(models.Model):
    devnameid = models.AutoField(primary_key=True, db_column='DEVNAMEID', unique=True)  # Field name made lowercase.
...
class Emdevices(models.Model):
    deviceid = models.AutoField(primary_key=True, db_column='DEVICEID', unique=True)  # Field name made lowercase.
...
class Empstatus(models.Model):
    statusid = models.AutoField(primary_key=True, db_column='STATUSID')  # Field name made lowercase.
    empstatus = models.CharField(db_column='EMPSTATUS', max_length=100, blank=True, null=True)  # Field name made lowercase.
    disabled = models.IntegerField(db_column='DISABLED', blank=True, null=True)  # Field name made lowercase.
...
class Finances(models.Model):
    financeid = models.AutoField(primary_key=True, db_column='FINANCEID', unique=True)  # Field name made lowercase.
    clientid = models.IntegerField(db_column='CLIENTID')  # Field name made lowercase.
    programid = models.IntegerField(db_column='PROGRAMID', blank=True, null=True)  # Field name made lowercase.
...
class History(models.Model):
    histid = models.AutoField(primary_key=True, db_column='HISTID', unique=True)  # Field name made lowercase.
...
class Hwpackage(models.Model):
    packageid = models.AutoField(primary_key=True, db_column='PACKAGEID', unique=True)  # Field name made lowercase.
    programid = models.IntegerField(db_column='PROGRAMID', blank=True, null=True)  # Field name made lowercase.
...
class It(models.Model):
    itid = models.AutoField(primary_key=True, unique=True)
...
class Itcatown(models.Model):
    itcatid = models.AutoField(primary_key=True, unique=True)
    category = models.CharField(max_length=100, blank=True, null=True)
...
class Itstatus(models.Model):
    itstatid = models.AutoField(primary_key=True, unique=True)
...
class Mastscore(models.Model):
    mastid = models.AutoField(primary_key=True, unique=True)
...
class Policereports(models.Model):
    prid = models.AutoField(primary_key=True, db_column='PRID', unique=True)  # Field name made lowercase.
...
class Prepostscore(models.Model):
    prepostid = models.AutoField(primary_key=True, db_column='PREPOSTID', unique=True)  # Field name made lowercase.
    clientid = models.IntegerField(db_column='CLIENTID', blank=True, null=True)  # Field name made lowercase.
    programid = models.IntegerField(db_column='PROGRAMID', blank=True, null=True)  # Field name made lowercase.
...
class Programdays(models.Model):
    programid = models.AutoField(primary_key=True, db_column='PROGRAMID', unique=True)  # Field name made lowercase.
...
class Programs(models.Model):
    programid = models.AutoField(primary_key=True, db_column='PROGRAMID', unique=True)  # Field name made lowercase.
    userid = models.ForeignKey('Clients', on_delete=models.CASCADE,  db_column='USERID', blank=True, null=True)  # Field name made lowercase.
...
class Providers(models.Model):
    providerid = models.AutoField(primary_key=True, db_column='PROVIDERID', unique=True)  # Field name made lowercase.
    providername = models.CharField(db_column='PROVIDERNAME', max_length=200, blank=True, null=True)  # Field name made lowercase.
...
class Reminder(models.Model):
    rid = models.AutoField(primary_key=True, db_column='RID', unique=True)  # Field name made lowercase.
    programid = models.IntegerField(db_column='PROGRAMID', blank=True, null=True)  # Field name made lowercase.
    clientid = models.IntegerField(db_column='CLIENTID', blank=True, null=True)  # Field name made lowercase.
...
class Transactiontypes(models.Model):
    transactid = models.AutoField(primary_key=True, db_column='TRANSACTID', unique=True)  # Field name made lowercase.
...
class Treatmentplan(models.Model):
    ...
    clientid = models.ForeignKey('Clients', db_column='CLIENTID', on_delete=models.CASCADE)  # Field name made lowercase.
    programid = models.IntegerField(db_column='PROGRAMID')  # Field name made lowercase.
...
class Unittype(models.Model):
    unittypeid = models.AutoField(primary_key=True, db_column='UNITTYPEID', unique=True)  # Field name made lowercase.
...
class Violations(models.Model):
    vioid = models.AutoField(primary_key=True, db_column='VIOID', unique=True)  # Field name made lowercase.
    viouserid = models.ForeignKey('Clients', on_delete=models.CASCADE, db_column='VIOUSERID', blank=True, null=True)  # Field name made lowercase.
